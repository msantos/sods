...
static unsigned char base32Lookup[BASE32_LOOKUP_MAX][2] = {
    {'0', 0xFF}, {'1', 0xFF}, {'2', 0x1A}, {'3', 0x1B}, {'4', 0x1C},
    {'5', 0x1D}, {'6', 0x1E}, {'7', 0x1F}, {'8', 0xFF}, {'9', 0xFF},
    {':', 0xFF}, {';', 0xFF}, {'<', 0xFF}, {'=', 0xFF}, {'>', 0xFF},
    {'?', 0xFF}, {'@', 0xFF}, {'A', 0x00}, {'B', 0x01}, {'C', 0x02},
    {'D', 0x03}, {'E', 0x04}, {'F', 0x05}, {'G', 0x06}, {'H', 0x07},
    {'I', 0x08}, {'J', 0x09}, {'K', 0x0A}, {'L', 0x0B}, {'M', 0x0C},
    {'N', 0x0D}, {'O', 0x0E}, {'P', 0x0F}, {'Q', 0x10}, {'R', 0x11},
    {'S', 0x12}, {'T', 0x13}, {'U', 0x14}, {'V', 0x15}, {'W', 0x16},
...
int base32_decode_length(int base32Length) { return ((base32Length * 5) / 8); }

void base32_encode_into(const void *_buffer, unsigned int bufLen,
                        char *base32Buffer) {
...
int base32_decode_into(const char *base32Buffer, unsigned int base32BufLen,
                       void *_buffer) {
